...
function OpenCloakroomMenu()
    ...
    {label = _U('gilet_wear1'), uniform = 'gilet_wear1'},
    {label = _U('gilet_wear2'), uniform = 'gilet_wear2'},
    {label = _U('gilet_wear3'), uniform = 'gilet_wear3'},
    {label = _U('gilet_wear4'), uniform = 'gilet_wear4'},
    {label = _U('gilet_wear5'), uniform = 'gilet_wear5'},
    {label = _U('gilet_wear6'), uniform = 'gilet_wear6'},
	}
...
---  LEVANTAR HERIDO       ---
------------------------------
RegisterNetEvent('commando:løft')
AddEventHandler('commando:løft', function()
  		 local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
	if closestPlayer == -1 or closestDistance > 1.1 then
				exports['mythic_notify']:DoCustomHudText('der er ingen nær spillere', 'no_players',3500)
				else
